...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-09-2021 a las 19:52:59
...
CREATE TABLE `factura` (
  ...
  `envio_domiciliario_iddomiciliario1` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `factura`
  ADD PRIMARY KEY (`idfactura`,`cliente_idcliente`,`envio_idenvio`,`envio_domiciliario_iddomiciliario1`),
  ADD KEY `fk_factura_cliente1_idx` (`cliente_idcliente`),
  ADD KEY `fk_factura_envio1_idx` (`envio_idenvio`,`envio_domiciliario_iddomiciliario1`);
...
ALTER TABLE `producto`
  ADD PRIMARY KEY (`idproducto`,`administrador_idadministrador`,`marca_idmarca`,`tipoproducto_idtipoproducto`),
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `fk_factura_envio1` FOREIGN KEY (`envio_idenvio`,`envio_domiciliario_iddomiciliario1`) REFERENCES `envio` (`idenvio`, `domiciliario_iddomiciliario1`) ON DELETE NO ACTION ON UPDATE NO ACTION;
