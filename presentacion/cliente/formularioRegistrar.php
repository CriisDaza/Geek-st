		...
		<div class="col-10 col-sm-8 col-lg-4">
			<div class="card">
				...
				<div class="card-body">
                    ...
                    ?>
					<form
						action="index.php?pid=<?php echo base64_encode("presentacion/cliente/formularioRegistrar.php") ?>"
						method="post">
						<div class="mb-3">
						...
						<div class="mb-3">
							<label class="form-label">Correo</label> <input type="email"
								class="form-control" name="correo" required="required">
						</div>
						<div class="mb-3">
							<label class="form-label">Clave</label> <input type="password"
								class="form-control" name="clave" required="required">
						</div>
						<div class="mb-3">
							<label class="form-label">Direccion</label> <input type="text"
								class="form-control" name="direccion" required="required">
						</div>
						<div class="d-grid">
						...
						<p>
							<a
								href="index.php?pid= <?php echo base64_encode("presentacion/formularioIngresar.php")?>">
