        ...
        ?>
			...
			<tr>
				...
				<td class="text-center">
					<form
						action="index.php?pid=<?php echo  base64_encode("presentacion/cliente/carrito.php")?>"
						method="post">
						<div class=row>
								...
								<select class="form-select"
									...
									<option value="1"
										<?php if($productoActual -> getCantidad() == 1) echo "selected"?>>1</option>
									<option value="2"
										<?php if($productoActual -> getCantidad() == 2) echo "selected"?>>2</option>
									<option value="3"
										<?php if($productoActual -> getCantidad() == 3) echo "selected"?>>3</option>
									<option value="4"
										<?php if($productoActual -> getCantidad() == 4) echo "selected"?>>4</option>
									<option value="5"
										<?php if($productoActual -> getCantidad() == 5) echo "selected"?>>5</option>
...
<?php } ?>
			...
			<tr>
				<td colspan="6" align="right"><form
						action="index.php?pid=<?php echo  base64_encode("presentacion/cliente/comprar.php")?>"
						method="post">
