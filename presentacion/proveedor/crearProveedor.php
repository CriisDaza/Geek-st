...
if(isset($_POST["crear"])){
    ...
    $proveedor=new Proveedor("",$_POST["nombre"], $_POST["apellido"], $_POST["correo"], $_POST["clave"], 1,$_SESSION["id"]);
    $proveedor -> Crear();
}
?>
...
<div class="card">
<h5 class="card-header">Crear Proveedor</h5>
<div class="card-body">
<?php
if (isset($_POST["crear"])) {
...
?>
					<form action="index.php?pid=<?php echo base64_encode("presentacion/proveedor/crearProveedor.php") ?>" method="post">
						<div class="mb-3">
